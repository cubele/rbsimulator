...
pub const PLAY_AREA_HEIGHT: f32 = INNER_WINDOW_HEIGHT - TOP_FRAME_HEIGHT - BOTTOM_FRAME_HEIGHT;
...
pub const PLAY_AREA_Y_MAX: f32 = INNER_WINDOW_Y_MAX - TOP_FRAME_HEIGHT;
...
pub const TOP_SLOT_PADDING: f32 = 30. + TOP_SLOT_SIZE / 2.;
pub const TOP_SLOT_START_X: f32 = PLAY_AREA_X_MIN + TOP_SLOT_PADDING;
pub const TOP_SLOT_END_X: f32 = PLAY_AREA_X_MAX - TOP_SLOT_PADDING;
...
pub const TOP_SPAWN_PADDING: f32 = 150.;
pub const TOP_SPAWN_X_START: f32 = PLAY_AREA_X_MIN + TOP_SPAWN_PADDING;
pub const TOP_SPAWN_X_END: f32 = PLAY_AREA_X_MAX - TOP_SPAWN_PADDING;
pub const TOP_SPAWN_X_SPACING: f32 = (TOP_SPAWN_X_END - TOP_SPAWN_X_START) / (TOP_SLOT_COUNT_F - 1.0);

pub const OBJ_TIME: f64 = 0.7;
pub const SPAWN_X_MIN: f32 = PLAY_AREA_X_MIN + OBJECT_SIZE / 2.;
pub const SPAWN_X_MAX: f32 = PLAY_AREA_X_MAX - OBJECT_SIZE / 2.;
pub const SPAWN_POSITION: f32 = PLAY_AREA_Y_MAX + OBJECT_SIZE / 2.;
...
pub const BOTTOM_SLOT_PADDING: f32 = TOP_SLOT_PADDING + OBJECT_SIZE / 2.;
