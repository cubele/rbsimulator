...
pub const SLIDE_GEN_Y: f32 = PLAY_AREA_MIDDLE_Y - OBJECT_SIZE * HIGH_SPEED / 3.;

pub const JUDGE_LINE_WIDTH: f32 = INNER_WINDOW_WIDTH;
pub const JUDGE_LINE_HEIGHT: f32 = 50.;
pub const JUDGE_LINE_PADDING: f32 = 140.;
...
pub const TOP_SLOT_PADDING_X: f32 = OBJECT_SIZE / 2. + TOP_SLOT_SIZE / 2.;
...
pub const TOP_SLOT_PADDING_Y: f32 = 340.;
...
pub const SPAWN_Y_POSITION: f32 = OPPONENT_JUDGE_LINE_POSITION - OBJECT_SIZE * 1.5;
...
pub const REFLEC_PADDING_TOP: f32 = TOP_SLOT_PADDING_Y * HIGH_SPEED;
pub const REFLECT_Y_MAX: f32 = PLAY_AREA_Y_MAX - REFLEC_PADDING_TOP;
pub const REFLEC_PADDING_BOTTOM: f32 = (TOP_SLOT_PADDING_Y + OBJECT_SIZE) * HIGH_SPEED;
pub const REFLECT_Y_MIN: f32 = PLAY_AREA_Y_MIN + REFLEC_PADDING_BOTTOM;
...
// audio
pub const AUDIO_DELAY: f64 = 0.;
pub const VOLUME_SONG: f32 = 0.10;
pub const VOLUME_SFX: f32 = 0.20;
